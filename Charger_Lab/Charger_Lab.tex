...
\end{abstract}
\section{Components of the Circuit}
The components of the circuit are:
\begin{enumerate}
    \item \textbf{Step-down transformer}
    \begin{description}
     \item The transformer is a centre-tapped 12-0-12 step-down 
...
a 12 V, 50 Hz AC sinusoid.
     \end{description}
    \item \textbf{Full-wave bridge rectifier}
    \begin{description}
     \item The full-wave rectifier is realized using four Si diodes arranged in a
bridge form as shown in Fig. \ref{fig:ckt}. The output waveform at this
stage is a DC 12 V, 50 Hz rectified sinusoid.
     \end{description}
    \item \textbf{RC filtering circuit}
    \begin{description}
     \item This is the main component of the charging circuit. The 100 $mu$F
...
required DC 5V supply.
     \end{description}
    \item \textbf{5 V Regulator}
    \begin{description}
     \item The regulator used in this circuit is a 7805 regulator, which outputs
...
\end{enumerate}
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{circfig.jpeg}
    \caption{Diagram of the circuit.}
    \label{fig:ckt}
\end{figure}
